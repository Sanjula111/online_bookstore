        ...
        <div class='col-sm-4 col-sm-6 single'>
                <div class='product'>
                    <a href='./details.php?pro_id=$pro_id'>
                        <br><img class='img-responsive' id='image-home' src='./admin_area/product_images/$pro_img'>
                    </a>
                    <div class='text'>
                        <h3><a href='./details.php?pro_id=$pro_id'>$pro_title</a></h3>
                        <p class='price'>Rs. $pro_price</p>
                        <p class='button'>
                            <a href='./details.php?pro_id=$pro_id' class='btn btn-info'>View Details</a>
                        </p>
                    </div>
                </div>
            </div>
...
function getpcatpro(){
    ...
    if(isset($_GET['p_cat'])){
        ...
        while($row_products = mysqli_fetch_array($run_products)){
            ...
            echo "<div class='col-md-3 col-sm-8 center-responsive'>
                    <div class='product'>
                            <a href='./details.php?pro_id=$pro_id'>
                        ...
                        <div class='text'>
                            ...
                            <a href='./details.php?pro_id=$pro_id' class='btn btn-primary'><i class='fa fa-cart-plus'></i>&nbspAdd To Cart</a>
                            </p>
                        </div>
                    </div>
                </div>";
