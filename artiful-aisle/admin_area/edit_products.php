...
if(isset($_POST['update'])){
    ...
    $update_product = "update products set p_cat_id='$product_cat',date=NOW(),product_title='$product_title',product_img='$product_img',product_keywords='$product_keywords',product_des='$product_desc',product_price='$product_price' where product_id='$p_id'";
